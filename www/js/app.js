...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.bairro-detail', {
    url: '/bairros/:id',
    views: {
      'tab-bairros': {
        templateUrl: 'templates/bairro-detail.html',
        controller: 'BairrosDetailCtrl',
        controllerAs: 'vm',
        cache: false
      }
    }
  ...
  .state('tab.vereadores', {
    ...
    .state('tab.vereador-detail', {
      url: '/vereadores/:vereadorId',
      views: {
        'tab-vereadores': {
